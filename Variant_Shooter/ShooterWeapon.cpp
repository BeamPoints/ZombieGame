...
void AShooterWeapon::BeginPlay()
{
	...
	GetRootComponent()->SetWorldLocationAndRotation(PawnOwner->GetActorLocation(), (PawnOwner->GetActorRotation() + FRotator(0, -90, 0)));
...
void AShooterWeapon::DoReload()
{
	if (CurrentBullets < MagazineSize )
	{
		...
		// notify the owner
		WeaponOwner->UpdateWeaponHUD(CurrentBullets, MagazineSize);
		WeaponOwner->OnWeaponReloaded(this);
